-- Trigger to notify Store Owner about new messages from Customers (Include role for UI masking)
    ...
    IF NEW.sender_type = 'customer' THEN
        ...
        VALUES (
            ...
            jsonb_build_object(
                ...
                'actor_role', customer_role, -- Added for UI masking
                'comment', NEW.content
            )
        );
    END IF;
...
-- Trigger to notify Store Owner about new reviews (Include role for UI masking)
...
BEGIN
    ...
    VALUES (
        ...
        jsonb_build_object(
            ...
            'actor_role', actor_role -- Added for UI masking
        )
    );
